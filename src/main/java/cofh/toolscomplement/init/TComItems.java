...
public class TComItems {
    ...
    public static void register() {
        ...
        registerExtraToolSet("iron", ItemTier.IRON);
        registerExtraToolSet("gold", ItemTier.GOLD);
        registerExtraToolSet("diamond", ItemTier.DIAMOND);
        registerExtraToolSet("netherite", ItemTier.NETHERITE);
        ...
        registerArmorSet("copper", ARMOR_MATERIAL_COPPER);
        registerArmorSet("tin", ARMOR_MATERIAL_TIN);
        registerArmorSet("lead", ARMOR_MATERIAL_LEAD);
        registerArmorSet("silver", ARMOR_MATERIAL_SILVER);
        registerArmorSet("nickel", ARMOR_MATERIAL_NICKEL);
        registerArmorSet("bronze", ARMOR_MATERIAL_BRONZE);
        registerArmorSet("electrum", ARMOR_MATERIAL_ELECTRUM);
        registerArmorSet("invar", ARMOR_MATERIAL_INVAR);
        registerArmorSet("constantan", ARMOR_MATERIAL_CONSTANTAN);
    }
    ...
    // region HELPERS
    private static void registerFullToolSet(String prefix, IItemTier tier) {

        registerStandardToolSet(prefix, tier);
        registerExtraToolSet(prefix, tier);
    }

    private static void registerStandardToolSet(String prefix, IItemTier tier) {

        ITEMS.register(prefix + "_shovel", () -> new ShovelItemCoFH(tier, 1.5F, -3.0F, new Item.Properties()).setDisplayGroup(() -> ToolsComplement.toolGroup));
        ITEMS.register(prefix + "_pickaxe", () -> new PickaxeItemCoFH(tier, 1, -2.8F, new Item.Properties()).setDisplayGroup(() -> ToolsComplement.toolGroup));
        ITEMS.register(prefix + "_axe", () -> new AxeItemCoFH(tier, tier.getAttackDamageBonus() > 0 ? 8.0F - tier.getAttackDamageBonus() : 6.0F, MathHelper.clamp(-3.7F + tier.getSpeed() / 10, -3.2F, -3.0F), new Item.Properties()).setDisplayGroup(() -> ToolsComplement.toolGroup));
        ITEMS.register(prefix + "_hoe", () -> new HoeItemCoFH(tier, -tier.getLevel(), Math.min(-3.0F + tier.getLevel(), 0.0F), new Item.Properties()).setDisplayGroup(() -> ToolsComplement.toolGroup));

        ITEMS.register(prefix + "_sword", () -> new SwordItemCoFH(tier, 3, -2.4F, new Item.Properties()).setDisplayGroup(() -> ToolsComplement.combatGroup));
    }

    private static void registerExtraToolSet(String prefix, IItemTier tier) {

        ITEMS.register(prefix + "_excavator", () -> new ExcavatorItem(tier, new Item.Properties()).setDisplayGroup(() -> ToolsComplement.toolGroup));
        ITEMS.register(prefix + "_hammer", () -> new HammerItem(tier, new Item.Properties()).setDisplayGroup(() -> ToolsComplement.toolGroup));
        ITEMS.register(prefix + "_sickle", () -> new SickleItem(tier, new Item.Properties()).setDisplayGroup(() -> ToolsComplement.toolGroup));

        ITEMS.register(prefix + "_knife", () -> new KnifeItem(tier, new Item.Properties()).setDisplayGroup(() -> ToolsComplement.combatGroup));
    }

    private static void registerArmorSet(String prefix, IArmorMaterial material) {

        ITEMS.register(prefix + "_helmet", () -> new ArmorItemCoFH(material, EquipmentSlotType.HEAD, new Item.Properties()).setDisplayGroup(() -> ToolsComplement.combatGroup));
        ITEMS.register(prefix + "_chestplate", () -> new ArmorItemCoFH(material, EquipmentSlotType.CHEST, new Item.Properties()).setDisplayGroup(() -> ToolsComplement.combatGroup));
        ITEMS.register(prefix + "_leggings", () -> new ArmorItemCoFH(material, EquipmentSlotType.LEGS, new Item.Properties()).setDisplayGroup(() -> ToolsComplement.combatGroup));
        ITEMS.register(prefix + "_boots", () -> new ArmorItemCoFH(material, EquipmentSlotType.FEET, new Item.Properties()).setDisplayGroup(() -> ToolsComplement.combatGroup));
    }
    // endregion
}
